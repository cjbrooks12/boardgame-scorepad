...
group = "com.caseyjbrooks.scorepad.app"
version = "1.0.0"
    ...
    sourceSets {
        ...
        val commonMain by getting {
            dependencies {
                ...
                implementation("io.github.copper-leaf:thistle-core:4.0.0")
...
buildConfig {
    ...
    if (project.hasProperty("release")) {
        ...
        buildConfigField("String", "BASE_URL", "\"https://cjbrooks12.github.io/boardgame-scorepad\"")
        buildConfigField("String?", "BASE_PATH", "\"/boardgame-scorepad\"")
    } else {
